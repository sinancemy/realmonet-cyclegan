...
train_photos, test_photos = torch.utils.data.random_split(photo_set, photo_set.get_split(0.92))
...
train_paintings, test_paintings = torch.utils.data.random_split(painting_set, painting_set.get_split(0.92))
...
_util.plot_output(A_to_B_output)
_util.plot_output(B_to_A_output)
